...
final class PropertyAdminController extends CRUDController
{
...
//
                    if ($imageToUpload) {
                        ...
                        $submittedObject->setImageFile($newFilename);
                    }
     ...
     */
    private function setFormTheme($formView, array $theme = null): void
    {
        $twig = $this->get('twig');
